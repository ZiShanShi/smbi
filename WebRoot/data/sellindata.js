		...
		dimension: [
		    {code: "peroid", text: "期间", fields: [
    		    ...
    		    {caption: "月份", field: "month", filterField: "month",type:'select',
                    ...
                    {caption: "库存时间", field: "BizDate", filterField: "BizDate",type:'date',defaultadded:true, url:"root/data/procedure/getLastDataTime?DDITable=DDIDaily_I"
					},
    		    	                               
		     ]},
			 {code: "territory", text: "架构", fields: [
			    {caption: "大区经理", field: "RSM", filterField: "name",showField: "RSMname",type:'select',defaultadded:true, url:"root/data/procedure/getrsm"},
			    {caption: "主管", field: "Supervisor", filterField: "name",showField: "Supervisorname", type:'select',},
			    {caption: "销售", field: "Salesperson",filterField: "name", showField: "Salespersonname", type:'select',}
			 ]},
			 {code: "area", text: "区域", fields: [
			    {caption: "大区", field: "region", filterField: "region", type:'select',defaultadded:true, url:"root/data/procedure/getrsm"},
